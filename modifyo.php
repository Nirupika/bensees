            ...
            <div class="card">
                            <form class="form-horizontal">
                              <div class="form-group col-md-12 col-sm-6 col-xs-12">  
                                <div class="card-body">
                                    <h4 class="card-title"><b>Modify Order</b></h4>
                                        <div class="form-group row">
                                            <label class="col-md-5 m-t-15">Change Item </label>
                                    ...
                                    <div class="form-group row">
                                            <label class="col-md-5" for="item Name">Change Item Name</label>
                                        <div class="col-md-7">
                                            <input type="text" id="item Name" class="form-control" placeholder="Change Item Name" disabled>
                                         </div>
                                    </div>
                                    <div class="form-group row">
                                    <label class="col-md-5 m-t-15">Change Brand </label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-5 m-t-15" for="sup">Change Supplier</label>
                                        <div class="col-sm-7">
                                            <div class="col-md-12">
                                            <select class="select2 form-control custom-select" style="width: 100%; height:20px;">
